...
class _DateTimePickerState extends State<DateTimePicker> {
  ...
  void initialize() {
    ...
    yearData = List.generate(year, (int index) => startDate.year + index);
  ...
  List<int> addList(int maxNumber) =>
      List.generate(maxNumber, (int index) => index);
  ...
  Widget buildUnit(String? unit) =>
      ...
      Center(child: Text(unit!, style: Theme.of(context).textTheme.bodyLarge));
